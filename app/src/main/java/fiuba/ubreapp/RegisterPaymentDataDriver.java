...
public class RegisterPaymentDataDriver extends AppCompatActivity implements OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_register_payment_data_driver);
    ...
    public void onClick (View v) {
        ...
        if(v.getId() == R.id.button4){
            ...
            if(!bname && !bcardnumber && !bmonth && !byear && !bccvv){
                ...
                progressDialog = new ProgressDialog(RegisterPaymentDataDriver.this,
